...
<section id="" class="content">
    ...
    {{ Form::model($permission, ['method' => 'PUT', 'url' => url('permission', $permission->id), 'class' => 'form-horizontal']) }}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10 col-md-3">
            <select id="group_id" class="form-control" name="group_id">
                ...
                <option value={{ $group->id }}{{ $group->id === $permission->group_id ? ' selected="selected"' : '' }}>
                    {{ $group->name }}
                </option>
                @endforeach
            </select>
