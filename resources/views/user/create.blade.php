...
@section('content')
    ...
    <section id="userEditContainer" class="content">
        ...
        {{ Form::open(['url' => url('user'), 'class' => 'form-horizontal']) }}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10 col-md-3">
                <img class="img-circle" alt="User Image" width="80" height="80">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10 col-md-3">
                {{ Form::text('cellphone', null, ['class' => 'form-control', 'placeholder' => '请输入手机号(可选)']) }}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10 col-md-3">
                {{ Form::text('email', null, ['class' => 'form-control', 'placeholder' => '请输入电子邮箱(可选)']) }}
            </div>
        </div>
...
@section('footer')
    ...
    <script src="{{ jsAsset('dist/js/user_create.bundle.js') }}"></script>
@stop