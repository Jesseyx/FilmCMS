                ...
                <div className="box-body">
                    <form className="form-inline" ref="form">
                        ...
                        <div className="form-group">
                            ...
                            <input id="name" className="form-control" type="text" name="name" placeholder="权限名称" />
                        </div>
                        <div className="form-group">
                            <label htmlFor="name">所属分组名称：</label>
                            <input id="name" className="form-control" type="text" name="group_name" placeholder="所属分组名称" />
                        </div>
